...
import com.codecode.order.entity.HistorySequence;
...
@Service
public class HistorySequenceGenerator {
    private final MongoOperations mongoOperations;

    @Autowired
    public HistorySequenceGenerator(MongoOperations mongoOperations) {
        this.mongoOperations = mongoOperations;
    }

    public int generateNextOrderId() {
        //findAndModify: find a document and modify it in a single atomic operation
        HistorySequence counter = mongoOperations.findAndModify(
